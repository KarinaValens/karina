export const project= [
  ...
  mockup: '/media/projects/Colors_&_Animations/colors&animations_mockup.png',
  image: '/media/projects/Colors_&_Animations/colors&animations_color_palette.png',
  ...
  image2: '/media/projects/Colors_&_Animations/colors&animations_light_mode.jpg',
  detail2: 'I decided to play with gradients as well. Not just because it is a trend, but also because the gradients make colors both strong and subtle at the same time, without the need to use an extensive color palette.',
  image3: '/media/projects/Colors_&_Animations/colors&animations_dark-mode.jpg',
  detail3: 'In order to make the dark theme in the page, I used a bigger percentage of the dark colors in the gradients. That overall, worked quite well across the page. Although if I would have more time to work on the project. I would try to make the text more readable and darken the high-light sections that looks pretty much the same in the light and dark theme.',
  url:	'https://karinavalens.github.io/Karina-Valens_13c.01.02.colors-and-animations/',
 } ,
 {
 id: '2',
 name:	'Sleepy-Baby',	
 projectimg:'/media/projects/Sleepy_Baby/sleepy_baby_game_final_design.jpg',
 ...
 mockup:'/media/projects/Sleepy_Baby/sleepy-baby-game_mockup.png',
 image: '/media/projects/Sleepy_Baby/sleepy-baby-game-predesign.jpg',
 ...
 image2: '/media/projects/Sleepy_Baby/sleepy-baby-game_state-maching-diagram.png',
 detail2: 'What I can say about this assignment is that it is extremely basic. My knowledge of design, coding, user interface, technical documentation, and much more; have developed greatly since I made this assignment. In a short period of 5 weeks, I had to master several programs that I was totally new to:[Adobe Illustrator, CSS animations,	JavaScript,	Technical Documentation, Design UI/UX, Color theory', 
 url: '/media/projects/Sleepy-Baby_game/index.html'

 }, 
 {    
id:'3',	  
name : 'Solomon Sound Therapy',
projectimg:'/media/projects/Solomon_Sound_Therapy/Solomon_Sound_Therapy_final.jpg',
...
mockup: '/media/projects/Solomon_Sound_Therapy/Solomon_Sound_Therapy_mockup.png',
image: '/media/projects/Solomon_Sound_Therapy/Solomon_Sound_Therapy_final.jpg',
detail:	'My role In this project, was: research, analysis and development We had to analyze the client business, niche, the trends in design inside the client niche. It was a complete exercise about how to develop a digital solution for a customer, that reaches every aspect of its business SoMe trends, design trends, the business tone of voice, visual content production (video production for SoMe and the web). Among other aspects of the client business. We code the page with the client information, but we change completely the design, in base of extensive research.',
image2: '/media/projects/Solomon_Sound_Therapy/Solomon_Sound_Therapy_considerations.jpg',
...
image3: '/media/projectsmSolomon_Sound_Therapy/Solomon_Sound_Therapy_RestApi.jpg',	
detail3: ' ',
...
projectimg:'/media/projects/Hack_Hogwarts_Student_list/hogwarts-student-list_final.png',
