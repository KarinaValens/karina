export const projects = [
  {
    ...
    detail:
      "The recipe collection is designed to feel personal and intuitive. Users can browse, search by name, or filter by favorites. Each card displays the photo, category, cooking time, and ingredient count at a glance — making it easy to decide what to cook.",
    image2: "/media/projects/WithHomeTaste/wht_add_recipe_mockup.jpg",
    detail2:
      "Adding recipes is where the app shines. Users can snap a photo of a cookbook page and let AI extract the full recipe, paste a URL to import from any recipe site, or type it in manually. The AI handles all the heavy lifting — parsing ingredients, steps, and metadata in seconds.",
    image3: "/media/projects/WithHomeTaste/wht_shopping_list_mockup.jpg",
    detail3:
      "A built-in shopping list connects directly to the recipe collection. Users can add all ingredients from a recipe with one tap, check items off while at the store, and add custom items. The goal was to make the journey from choosing a recipe to buying the ingredients completely seamless.",
    url: "",
  ...
  },
  {
    ...
    detail2:
      "The project combined multiple disciplines: custom illustration in Adobe Illustrator, CSS animations for game feedback, vanilla JavaScript for game logic, and UI/UX principles like Gestalt Laws and color theory to create an intuitive, playful interface.",
    image3: "/media/projects/Sleepy_Baby/sleepy_baby_win_screen.webp",
    detail3:
      "I designed and built everything end-to-end — from initial sketches and character design to the final animated screens. Each game state (playing, winning, losing) has its own visual treatment, giving the player clear, engaging feedback throughout the experience.",
  ...
  },
  {
    ...
    detail3:
      "Animations provide visual feedback throughout — when a student is expelled, their row animates out of the list. Pop-up modals communicate state changes clearly, keeping the user informed as the data shifts beneath them.",
